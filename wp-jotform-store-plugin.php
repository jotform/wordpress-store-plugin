 ...
 * Text Domain:       wp-jotform-store-plugin
 *
 ...
 */
function create_block_wp_jotform_store_plugin_block_init() {
...
add_action( 'init', 'create_block_wp_jotform_store_plugin_block_init' );
